...
Webブラウザのデベロッパツールを起動して（Ctrl + Shift + I）、"Network"を選択してください。右側に以下のように表示されることを確認してください。

<img src="devtool.png" width="500px">
