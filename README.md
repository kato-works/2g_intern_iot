...
<img alt="esp32" src="esp32_doc/esp32.jpg" width="200px"/>
...
初めて取り組む人は、まず以下の順番で進めてください。

1. セットアップを完了する
1. 必修課題 01 - 09 を順番に進める
1. 発展課題 10 - 13 から興味のあるものを選ぶ
1. クレーン応用課題、または自由設計課題に進む

> [!TIP]
> 途中で詰まったら、1つ前の課題に戻って「入力は取れているか」「出力は動いているか」「処理が分離できているか」を確認しましょう。

## 必修課題 01 - 09

まずはここまでを完走すると、ESP32を使った基本的なIoTデバイスを1つ作れる状態になります。
...
- LEDなどの出力を制御できる
- Wi-Fi経由でサーバへデータを送れる
- 入力、処理、出力を分けてコードを組み立てられる

## 発展課題 10 - 13

必修課題を終えた人向けです。興味のある入出力や通信方式を広げてください。
...
ここからは、実際の建機で使われる考え方に寄せて、測定対象と使い道を意識しながら取り組みます。
