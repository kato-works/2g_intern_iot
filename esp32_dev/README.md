...
1. "View"から"Files"を選択しビューを追加
   - <img src="thonny_dev_00.png" width="350px">
1. 左側のFilesビューで研修用に作成したフォルダを開く
   - <img src="thonny_dev_01.png" width="450px">
